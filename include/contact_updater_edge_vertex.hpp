#ifndef _MAKENA_CONTACT_UPDATER_EDGE_VERTEX_HPP_
#define _MAKENA_CONTACT_UPDATER_EDGE_VERTEX_HPP_
...
/**
 * @file contact_updater_edge_vertex.hpp
 *
 * @brief
 *
 */
...
class ContactUpdater_EDGE_VERTEX : public Loggable {

  public:

    ContactUpdater_EDGE_VERTEX(
...
#endif /*_MAKENA_GJK_CONTACT_UPDATER_EDGE_VERTEX_HPP_*/
