...
class Manifold : public Loggable {
  ...
  private:
     ...
     *
     *   @param pillarEdges (in): pillar edges around the center point of
     *                            the new faces.
     *
     ...
     *
     *  @param  pTest (in): the face whose edges are tested.
     *
     ...
     *
     *  @param list of connected coplanar faces found.
     */
